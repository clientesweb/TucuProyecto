document.addEventListener('DOMContentLoaded', function() {
    ...
    reasons.forEach((reason, index) => {
        ...
        reasonElement.setAttribute('data-aos-delay', (index *Optimización on-page y off-page</li>
                            <li>Creación de contenido optimizado</li>
                            <li>Seguimiento y análisis de resultados</li>
                        </ul>
                    </div>
    ...
    document.querySelector('button[data-service="nosotros"]').addEventListener('click', () => {
